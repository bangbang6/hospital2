...
<script>
const headerMockData = { "headerData": { "value": [{ "title": "医院总数", "subTitle": "The Hospital Number", "value": 72, "icon": "el-icon-office-building", color: 'pink' }, { "title": "用户总数", "subTitle": "The Total User Number", "value": 2465, "icon": "el-icon-user-solid", color: "blue" }, { "title": "文件总数", "subTitle": "The Total Files Number", "value": 12723, "icon": "el-icon-folder-opened", color: 'yellow' }, { "title": "区块数", "subTitle": "The Block Number", "value": 6391, "icon": "el-icon-coin", color: 'block' }, {"title": "节点数", "subTitle": "The Peer Number", "value": 4, "icon": "el-icon-coordinate", color: 'green'},{ "title": "交易数", "subTitle": "The Transaction Number", "value": 17352, "icon": "el-icon-sort", color: 'connect' }, { "title": "异常数", "subTitle": "The Number Of Abnormal", "value": 341, "icon": "el-icon-warning-outline", color: 'red' }] }, "project": { "value": [{ "title": "转化率", "value": "13.16%", "img": "https://www.youbaobao.xyz/datav-res/success.png" }, { "title": "退单率", "value": "5.73%", "img": "https://www.youbaobao.xyz/datav-res/failed.png" }] } }
export default {
  data () {
    return {
